...
public enum APIError: Error, Sendable, Equatable {
  /// A non-2xx (other than 401) whose body was the wire error envelope. Carries the wire `code` (a
  /// strict, wire-local `ErrorCode`), the safe `message`, optional `detail`, and the HTTP `status`.
  case envelope(code: ErrorCode, message: String, detail: String?, status: Int)
