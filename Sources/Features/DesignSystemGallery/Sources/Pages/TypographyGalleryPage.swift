...
struct TypographyGalleryPage: View {
  ...
  private let samples: [Sample] = [
    Sample(sample: "78", token: "text-display", spec: "64 / Bold — hero numerals (readiness score)",
           font: CoachFont.textDisplay),
    Sample(sample: "Coach", token: "text-3xl", spec: "40 / Bold — page hero",
           font: CoachFont.text3xl),
    Sample(sample: "Today", token: "text-2xl", spec: "30 / Bold — screen title",
           font: CoachFont.text2xl),
    Sample(sample: "Ready", token: "text-xl", spec: "24 / Bold — section & card headline",
           font: CoachFont.textXl),
    Sample(sample: "Good morning", token: "text-lg", spec: "17 / Semibold — headings & card names",
           font: CoachFont.textLg),
    Sample(sample: "You are recovered and clear to train.", token: "text-md", spec: "15 / Regular — body & narrative",
           font: CoachFont.textMd),
    Sample(sample: "35–45 min", token: "text-sm", spec: "13 / Semibold — data & secondary meta",
           font: CoachFont.textSm),
    Sample(sample: "keep HR ≤146 bpm", token: "text-xs", spec: "12 / Medium — captions & chips",
           font: CoachFont.textXs),
    Sample(sample: "READINESS", token: "text-2xs", spec: "11 / Bold — eyebrows & micro labels",
