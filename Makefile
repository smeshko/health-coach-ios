...
SNAPSHOT_TARGETS = -only-testing:DesignSystemSnapshotTests -only-testing:AppFeatureSnapshotTests -only-testing:OnboardingFeatureSnapshotTests -only-testing:SettingsFeatureSnapshotTests
